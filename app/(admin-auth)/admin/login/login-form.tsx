...
export function LoginForm({ initialError }: LoginFormProps) {
  ...
  return (
    <main className="fixed inset-0 z-50 flex min-h-svh flex-col items-center justify-center overflow-hidden bg-[#151411] px-4">
      <div className="pointer-events-none absolute inset-0 opacity-60">
        <div className="absolute left-1/2 top-1/2 -z-10 h-[28rem] w-[28rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#C6A15B]/10 blur-[140px]" />
      </div>
      ...
      <div className="relative w-full max-w-[420px]">
        <div className="relative overflow-hidden rounded-xl border border-[#C6A15B]/20 bg-[#1C1A16] p-6 shadow-2xl shadow-[#C6A15B]/10 sm:p-8">
          ...
          <div className="flex flex-col items-center">
            <div className="relative mb-5 h-20 w-32 drop-shadow-2xl">
              <Image
          ...
          >
            <label className="flex flex-col gap-2 text-sm text-[#F7F0E4]/80">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[#71695F] transition-colors hover:text-[#C6A15B]"
                >
            ...
            {error && (
              <p role="alert" className="rounded-sm bg-[#9B3444]/10 px-3 py-2 text-center text-sm text-[#9B3444]">
                {error}
              </p>
            )}
          ...
          <div className="mt-6 flex justify-center">
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-sm text-[#71695F] transition-colors hover:text-[#C6A15B]"
            >
