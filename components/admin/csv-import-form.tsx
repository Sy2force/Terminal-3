...
export function CsvImportForm() {
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-sm border border-white/10 bg-warm-black p-4 text-sm text-ivory/70">
        <p className="mb-2 font-medium text-ivory">Colonnes attendues (en-tête CSV) :</p>
        <code className="block overflow-x-auto rounded-sm bg-black/40 p-2 text-xs text-champagne">
      ...
      <input
        ...
        type="file"
        accept=".csv,text/csv"
        className="block w-full text-sm text-ivory/70 file:mr-4 file:rounded-full file:border-0 file:bg-champagne file:px-4 file:py-2 file:text-sm file:font-semibold file:text-obsidian"
      />
      ...
      <button
        ...
        disabled={importing}
        className="rounded-full bg-champagne px-6 py-2.5 text-sm font-semibold text-obsidian transition-colors hover:bg-soft-gold disabled:opacity-50"
      >
