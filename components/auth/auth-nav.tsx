    ...
    return (
      <div className="hidden items-center gap-2 lg:flex">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center h-[42px] px-[18px] rounded-[10px] border border-or-principal/50 text-[13px] font-semibold tracking-[0.02em] text-or-principal whitespace-nowrap transition-all hover:bg-or-principal/10 focus:outline-none focus:ring-2 focus:ring-or-principal"
        >
          Créer un compte
        </Link>
      </div>
